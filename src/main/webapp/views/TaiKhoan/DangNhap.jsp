						...
						<div class="col-sm-6 col-md-6">
							<ul class="">
								...
								<div>
									<p class="fw-light fst-italic fs-10 d-inline">Đăng nhập
										hoặc</p>
									<a class="link-opacity-Ìđ d-inline ms-1" href="DangKy.jsp">Tạo tài khoản</a>
								</div>
							</ul>
							<div class="container mt-4">
								...
								<div class="form-floating">
									...
									<p><a href="GuiMa.jsp" class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Bạn quên mật khẩu?</a></p>
